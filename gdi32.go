...
func AbortDoc(hdc HDC) int32 {
	ret, _, _ := syscall.SyscallN(abortDoc.Addr(),
		uintptr(hdc))
...
func AddFontResourceEx(lpszFilename *uint16, fl uint32, pdv unsafe.Pointer) int32 {
	ret, _, _ := syscall.SyscallN(addFontResourceEx.Addr(),
...
func AddFontMemResourceEx(pFileView uintptr, cjSize uint32, pvReserved unsafe.Pointer, pNumFonts *uint32) HANDLE {
	ret, _, _ := syscall.SyscallN(addFontMemResourceEx.Addr(),
		pFileView,
		uintptr(cjSize),
		uintptr(pvReserved),
...
func AlphaBlend(hdcDest HDC, nXOriginDest, nYOriginDest, nWidthDest, nHeightDest int32, hdcSrc HDC, nXOriginSrc, nYOriginSrc, nWidthSrc, nHeightSrc int32, ftn BLENDFUNCTION) bool {
	ret, _, _ := syscall.SyscallN(alphaBlend.Addr(),
		uintptr(hdcDest),
...
func BitBlt(hdcDest HDC, nXDest, nYDest, nWidth, nHeight int32, hdcSrc HDC, nXSrc, nYSrc int32, dwRop uint32) bool {
	ret, _, _ := syscall.SyscallN(bitBlt.Addr(),
		uintptr(hdcDest),
		uintptr(nXDest),
		uintptr(nYDest),
		uintptr(nWidth),
...
func ChoosePixelFormat(hdc HDC, ppfd *PIXELFORMATDESCRIPTOR) int32 {
	ret, _, _ := syscall.SyscallN(choosePixelFormat.Addr(),
		uintptr(hdc),
...
func CloseEnhMetaFile(hdc HDC) HENHMETAFILE {
	ret, _, _ := syscall.SyscallN(closeEnhMetaFile.Addr(),
		uintptr(hdc))
...
func CombineRgn(hrgnDest, hrgnSrc1, hrgnSrc2 HRGN, fnCombineMode int32) int32 {
	ret, _, _ := syscall.SyscallN(combineRgn.Addr(),
		uintptr(hrgnDest),
		uintptr(hrgnSrc1),
		uintptr(hrgnSrc2),
...
func CopyEnhMetaFile(hemfSrc HENHMETAFILE, lpszFile *uint16) HENHMETAFILE {
	ret, _, _ := syscall.SyscallN(copyEnhMetaFile.Addr(),
		uintptr(hemfSrc),
...
func CreateBitmap(nWidth, nHeight int32, cPlanes, cBitsPerPel uint32, lpvBits unsafe.Pointer) HBITMAP {
	ret, _, _ := syscall.SyscallN(createBitmap.Addr(),
		uintptr(nWidth),
		uintptr(nHeight),
		uintptr(cPlanes),
		uintptr(cBitsPerPel),
...
func CreateCompatibleBitmap(hdc HDC, nWidth, nHeight int32) HBITMAP {
	ret, _, _ := syscall.SyscallN(createCompatibleBitmap.Addr(),
		uintptr(hdc),
		uintptr(nWidth),
		uintptr(nHeight))
...
func CreateBrushIndirect(lplb *LOGBRUSH) HBRUSH {
	ret, _, _ := syscall.SyscallN(createBrushIndirect.Addr(),
...
func CreateCompatibleDC(hdc HDC) HDC {
	ret, _, _ := syscall.SyscallN(createCompatibleDC.Addr(),
		uintptr(hdc))
...
func CreateDC(lpszDriver, lpszDevice, lpszOutput *uint16, lpInitData *DEVMODE) HDC {
	ret, _, _ := syscall.SyscallN(createDC.Addr(),
...
func CreateDIBSection(hdc HDC, pbmih *BITMAPINFOHEADER, iUsage uint32, ppvBits *unsafe.Pointer, hSection HANDLE, dwOffset uint32) HBITMAP {
	ret, _, _ := syscall.SyscallN(createDIBSection.Addr(),
		uintptr(hdc),
...
func CreateEnhMetaFile(hdcRef HDC, lpFilename *uint16, lpRect *RECT, lpDescription *uint16) HDC {
	ret, _, _ := syscall.SyscallN(createEnhMetaFile.Addr(),
		uintptr(hdcRef),
...
func CreateFontIndirect(lplf *LOGFONT) HFONT {
	ret, _, _ := syscall.SyscallN(createFontIndirect.Addr(),
...
func CreateIC(lpszDriver, lpszDevice, lpszOutput *uint16, lpdvmInit *DEVMODE) HDC {
	ret, _, _ := syscall.SyscallN(createIC.Addr(),
		uintptr(unsafe.Pointer(lpszDriver)),
		uintptr(unsafe.Pointer(lpszDevice)),
		uintptr(unsafe.Pointer(lpszOutput)),
...
func CreatePatternBrush(hbmp HBITMAP) HBRUSH {
	ret, _, _ := syscall.SyscallN(createPatternBrush.Addr(),
		uintptr(hbmp))
...
func CreateRectRgn(nLeftRect, nTopRect, nRightRect, nBottomRect int32) HRGN {
	ret, _, _ := syscall.SyscallN(createRectRgn.Addr(),
		uintptr(nLeftRect),
		uintptr(nTopRect),
		uintptr(nRightRect),
		uintptr(nBottomRect))
...
func DeleteDC(hdc HDC) bool {
	ret, _, _ := syscall.SyscallN(deleteDC.Addr(),
		uintptr(hdc))
...
func DeleteEnhMetaFile(hemf HENHMETAFILE) bool {
	ret, _, _ := syscall.SyscallN(deleteEnhMetaFile.Addr(),
		uintptr(hemf))
...
func DeleteObject(hObject HGDIOBJ) bool {
	ret, _, _ := syscall.SyscallN(deleteObject.Addr(),
		uintptr(hObject))
...
func Ellipse(hdc HDC, nLeftRect, nTopRect, nRightRect, nBottomRect int32) bool {
	ret, _, _ := syscall.SyscallN(ellipse.Addr(),
		uintptr(hdc),
		uintptr(nLeftRect),
		uintptr(nTopRect),
		uintptr(nRightRect),
...
func EndDoc(hdc HDC) int32 {
	ret, _, _ := syscall.SyscallN(endDoc.Addr(),
		uintptr(hdc))
...
func EndPage(hdc HDC) int32 {
	ret, _, _ := syscall.SyscallN(endPage.Addr(),
		uintptr(hdc))
...
func ExcludeClipRect(hdc HDC, nLeftRect, nTopRect, nRightRect, nBottomRect int32) int32 {
	ret, _, _ := syscall.SyscallN(excludeClipRect.Addr(),
		uintptr(hdc),
		uintptr(nLeftRect),
		uintptr(nTopRect),
		uintptr(nRightRect),
...
func ExtCreatePen(dwPenStyle, dwWidth uint32, lplb *LOGBRUSH, dwStyleCount uint32, lpStyle *uint32) HPEN {
	ret, _, _ := syscall.SyscallN(extCreatePen.Addr(),
		uintptr(dwPenStyle),
		uintptr(dwWidth),
		uintptr(unsafe.Pointer(lplb)),
...
func FillRgn(hdc HDC, hrgn HRGN, hbr HBRUSH) bool {
	ret, _, _ := syscall.SyscallN(fillRgn.Addr(),
		uintptr(hdc),
		uintptr(hrgn),
		uintptr(hbr))
...
func GdiFlush() bool {
	ret, _, _ := syscall.SyscallN(gdiFlush.Addr())

	return ret != 0
}

func GetBkColor(hdc HDC) COLORREF {
	ret, _, _ := syscall.SyscallN(getBkColor.Addr(),
		uintptr(hdc))
...
func GetDeviceCaps(hdc HDC, nIndex int32) int32 {
	ret, _, _ := syscall.SyscallN(getDeviceCaps.Addr(),
		uintptr(hdc),
		uintptr(nIndex))
...
func GetDIBits(hdc HDC, hbmp HBITMAP, uStartScan uint32, cScanLines uint32, lpvBits *byte, lpbi *BITMAPINFO, uUsage uint32) int32 {
	ret, _, _ := syscall.SyscallN(getDIBits.Addr(),
		uintptr(hdc),
		uintptr(hbmp),
		uintptr(uStartScan),
		uintptr(cScanLines),
...
func GetEnhMetaFile(lpszMetaFile *uint16) HENHMETAFILE {
	ret, _, _ := syscall.SyscallN(getEnhMetaFile.Addr(),
...
func GetEnhMetaFileHeader(hemf HENHMETAFILE, cbBuffer uint32, lpemh *ENHMETAHEADER) uint32 {
	ret, _, _ := syscall.SyscallN(getEnhMetaFileHeader.Addr(),
		uintptr(hemf),
		uintptr(cbBuffer),
...
func GetObject(hgdiobj HGDIOBJ, cbBuffer uintptr, lpvObject unsafe.Pointer) int32 {
	ret, _, _ := syscall.SyscallN(getObject.Addr(),
		uintptr(hgdiobj),
		uintptr(cbBuffer),
		uintptr(lpvObject))
...
func GetPixel(hdc HDC, nXPos, nYPos int32) COLORREF {
	ret, _, _ := syscall.SyscallN(getPixel.Addr(),
		uintptr(hdc),
		uintptr(nXPos),
		uintptr(nYPos))
...
func GetRgnBox(hrgn HRGN, lprc *RECT) int32 {
	ret, _, _ := syscall.SyscallN(getRgnBox.Addr(),
		uintptr(hrgn),
...
func GetStockObject(fnObject int32) HGDIOBJ {
	ret, _, _ := syscall.SyscallN(getStockObject.Addr(),
		uintptr(fnObject))
...
func GetTextColor(hdc HDC) COLORREF {
	ret, _, _ := syscall.SyscallN(getTextColor.Addr(),
		uintptr(hdc))
...
func GetTextExtentExPoint(hdc HDC, lpszStr *uint16, cchString, nMaxExtent int32, lpnFit, alpDx *int32, lpSize *SIZE) bool {
	ret, _, _ := syscall.SyscallN(getTextExtentExPoint.Addr(),
		uintptr(hdc),
...
func GetTextExtentPoint32(hdc HDC, lpString *uint16, c int32, lpSize *SIZE) bool {
	ret, _, _ := syscall.SyscallN(getTextExtentPoint32.Addr(),
		uintptr(hdc),
...
func GetTextMetrics(hdc HDC, lptm *TEXTMETRIC) bool {
	ret, _, _ := syscall.SyscallN(getTextMetrics.Addr(),
		uintptr(hdc),
...
func GetViewportOrgEx(hdc HDC, lpPoint *POINT) bool {
	ret, _, _ := syscall.SyscallN(getViewportOrgEx.Addr(),
		uintptr(hdc),
...
func GradientFill(hdc HDC, pVertex *TRIVERTEX, nVertex uint32, pMesh unsafe.Pointer, nMesh, ulMode uint32) bool {
	ret, _, _ := syscall.SyscallN(gradientFill.Addr(),
		uintptr(hdc),
...
func IntersectClipRect(hdc HDC, nLeftRect, nTopRect, nRightRect, nBottomRect int32) int32 {
	ret, _, _ := syscall.SyscallN(intersectClipRect.Addr(),
		uintptr(hdc),
		uintptr(nLeftRect),
		uintptr(nTopRect),
		uintptr(nRightRect),
...
func LineTo(hdc HDC, nXEnd, nYEnd int32) bool {
	ret, _, _ := syscall.SyscallN(lineTo.Addr(),
		uintptr(hdc),
		uintptr(nXEnd),
		uintptr(nYEnd))
...
func MoveToEx(hdc HDC, x, y int, lpPoint *POINT) bool {
	ret, _, _ := syscall.SyscallN(moveToEx.Addr(),
		uintptr(hdc),
		uintptr(x),
		uintptr(y),
		uintptr(unsafe.Pointer(lpPoint)))
...
func PlayEnhMetaFile(hdc HDC, hemf HENHMETAFILE, lpRect *RECT) bool {
	ret, _, _ := syscall.SyscallN(playEnhMetaFile.Addr(),
		uintptr(hdc),
		uintptr(hemf),
		uintptr(unsafe.Pointer(lpRect)))
...
func Polyline(hdc HDC, lppt unsafe.Pointer, cPoints int32) bool {
	ret, _, _ := syscall.SyscallN(polyline.Addr(),
		uintptr(hdc),
		uintptr(lppt),
		uintptr(cPoints))
...
func RemoveFontResourceEx(lpszFilename *uint16, fl uint32, pdv unsafe.Pointer) bool {
	ret, _, _ := syscall.SyscallN(removeFontResourceEx.Addr(),
		uintptr(unsafe.Pointer(lpszFilename)),
		uintptr(fl),
		uintptr(pdv))
...
func RemoveFontMemResourceEx(h HANDLE) bool {
	ret, _, _ := syscall.SyscallN(removeFontMemResourceEx.Addr(),
		uintptr(h))
...
func ResetDC(hdc HDC, lpInitData *DEVMODE) HDC {
	ret, _, _ := syscall.SyscallN(resetDC.Addr(),
		uintptr(hdc),
		uintptr(unsafe.Pointer(lpInitData)))
...
func RestoreDC(hdc HDC, nSaveDC int32) bool {
	ret, _, _ := syscall.SyscallN(restoreDC.Addr(),
		uintptr(hdc),
		uintptr(nSaveDC))
	return ret != 0
}
...
func RoundRect(hdc HDC, nLeftRect, nTopRect, nRightRect, nBottomRect, nWidth, nHeight int32) bool {
	ret, _, _ := syscall.SyscallN(roundRect.Addr(),
		uintptr(hdc),
		uintptr(nLeftRect),
		uintptr(nTopRect),
		uintptr(nRightRect),
...
func SaveDC(hdc HDC) int32 {
	ret, _, _ := syscall.SyscallN(saveDC.Addr(),
		uintptr(hdc))
	return int32(ret)
}

func SelectObject(hdc HDC, hgdiobj HGDIOBJ) HGDIOBJ {
	ret, _, _ := syscall.SyscallN(selectObject.Addr(),
		uintptr(hdc),
		uintptr(hgdiobj))
...
func SetBkColor(hdc HDC, crColor COLORREF) COLORREF {
	ret, _, _ := syscall.SyscallN(setBkColor.Addr(),
		uintptr(hdc),
		uintptr(crColor))
...
func SetBkMode(hdc HDC, iBkMode int32) int32 {
	ret, _, _ := syscall.SyscallN(setBkMode.Addr(),
		uintptr(hdc),
		uintptr(iBkMode))
...
func SetBrushOrgEx(hdc HDC, nXOrg, nYOrg int32, lppt *POINT) bool {
	ret, _, _ := syscall.SyscallN(setBrushOrgEx.Addr(),
		uintptr(hdc),
		uintptr(nXOrg),
		uintptr(nYOrg),
...
func SetDIBits(hdc HDC, hbmp HBITMAP, uStartScan, cScanLines uint32, lpvBits *byte, lpbmi *BITMAPINFO, fuColorUse uint32) int32 {
	ret, _, _ := syscall.SyscallN(setDIBits.Addr(),
		uintptr(hdc),
		uintptr(hbmp),
		uintptr(uStartScan),
		uintptr(cScanLines),
...
func SetPixel(hdc HDC, X, Y int32, crColor COLORREF) COLORREF {
	ret, _, _ := syscall.SyscallN(setPixel.Addr(),
		uintptr(hdc),
		uintptr(X),
		uintptr(Y),
		uintptr(crColor))
...
func SetPixelFormat(hdc HDC, iPixelFormat int32, ppfd *PIXELFORMATDESCRIPTOR) bool {
	ret, _, _ := syscall.SyscallN(setPixelFormat.Addr(),
		uintptr(hdc),
...
func SetStretchBltMode(hdc HDC, iStretchMode int32) int32 {
	ret, _, _ := syscall.SyscallN(setStretchBltMode.Addr(),
		uintptr(hdc),
...
func SetTextColor(hdc HDC, crColor COLORREF) COLORREF {
	ret, _, _ := syscall.SyscallN(setTextColor.Addr(),
		uintptr(hdc),
		uintptr(crColor))
...
func SetViewportOrgEx(hdc HDC, x, y int32, lpPoint *POINT) COLORREF {
	ret, _, _ := syscall.SyscallN(setViewportOrgEx.Addr(),
		uintptr(hdc),
		uintptr(x),
		uintptr(y),
		uintptr(unsafe.Pointer(lpPoint)))
...
func StartDoc(hdc HDC, lpdi *DOCINFO) int32 {
	ret, _, _ := syscall.SyscallN(startDoc.Addr(),
		uintptr(hdc),
...
func StartPage(hdc HDC) int32 {
	ret, _, _ := syscall.SyscallN(startPage.Addr(),
		uintptr(hdc))
...
func StretchBlt(hdcDest HDC, nXOriginDest, nYOriginDest, nWidthDest, nHeightDest int32, hdcSrc HDC, nXOriginSrc, nYOriginSrc, nWidthSrc, nHeightSrc int32, dwRop uint32) bool {
	ret, _, _ := syscall.SyscallN(stretchBlt.Addr(),
		uintptr(hdcDest),
		uintptr(nXOriginDest),
		uintptr(nYOriginDest),
		uintptr(nWidthDest),
...
func SwapBuffers(hdc HDC) bool {
	ret, _, _ := syscall.SyscallN(swapBuffers.Addr(),
		uintptr(hdc))
...
func TextOut(hdc HDC, nXStart, nYStart int32, lpString *uint16, cchString int32) bool {
	ret, _, _ := syscall.SyscallN(textOut.Addr(),
		uintptr(hdc),
		uintptr(nXStart),
		uintptr(nYStart),
		uintptr(unsafe.Pointer(lpString)),
...
func TransparentBlt(hdcDest HDC, xoriginDest, yoriginDest, wDest, hDest int32, hdcSrc HDC, xoriginSrc, yoriginSrc, wSrc, hSrc int32, crTransparent uint32) bool {
	ret, _, _ := syscall.SyscallN(transparentBlt.Addr(),
		uintptr(hdcDest),
		uintptr(xoriginDest),
		uintptr(yoriginDest),
		uintptr(wDest),
