...
func TaskDialogIndirect(pTaskConfig *TASKDIALOGCONFIG, pnButton *int32, pnRadioButton *int32, pfVerificationFlagChecked *BOOL) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procTaskDialogIndirect.Addr(), uintptr(unsafe.Pointer(pTaskConfig)), uintptr(unsafe.Pointer(pnButton)), uintptr(unsafe.Pointer(pnRadioButton)), uintptr(unsafe.Pointer(pfVerificationFlagChecked)))
	ret = HRESULT(r0)
	return
}

func DwmExtendFrameIntoClientArea(hwnd HWND, inset *MARGINS) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDwmExtendFrameIntoClientArea.Addr(), uintptr(hwnd), uintptr(unsafe.Pointer(inset)))
	ret = HRESULT(r0)
	return
}

func DwmGetWindowAttribute(hwnd HWND, attribute DWMWINDOWATTRIBUTE, attrVal unsafe.Pointer, attrValLen uint32) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDwmGetWindowAttribute.Addr(), uintptr(hwnd), uintptr(attribute), uintptr(attrVal), uintptr(attrValLen))
	ret = HRESULT(r0)
	return
}

func DwmInvalidateIconicBitmaps(hwnd HWND) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDwmInvalidateIconicBitmaps.Addr(), uintptr(hwnd))
	ret = HRESULT(r0)
	return
}

func DwmQueryThumbnailSourceSize(thumbnail HTHUMBNAIL, size *SIZE) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDwmQueryThumbnailSourceSize.Addr(), uintptr(thumbnail), uintptr(unsafe.Pointer(size)))
	ret = HRESULT(r0)
	return
}

func DwmRegisterThumbnail(hwndDest HWND, hwndSrc HWND, handle *HTHUMBNAIL) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDwmRegisterThumbnail.Addr(), uintptr(hwndDest), uintptr(hwndSrc), uintptr(unsafe.Pointer(handle)))
	ret = HRESULT(r0)
	return
}

func DwmSetIconicLivePreviewBitmap(hwnd HWND, hbmp HBITMAP, clientRegionOffset *POINT, flags uint32) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDwmSetIconicLivePreviewBitmap.Addr(), uintptr(hwnd), uintptr(hbmp), uintptr(unsafe.Pointer(clientRegionOffset)), uintptr(flags))
	ret = HRESULT(r0)
	return
}

func DwmSetIconicThumbnail(hwnd HWND, hbmp HBITMAP, flags uint32) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDwmSetIconicThumbnail.Addr(), uintptr(hwnd), uintptr(hbmp), uintptr(flags))
	ret = HRESULT(r0)
	return
}

func DwmSetWindowAttribute(hwnd HWND, attribute DWMWINDOWATTRIBUTE, attrVal unsafe.Pointer, attrValLen uint32) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDwmSetWindowAttribute.Addr(), uintptr(hwnd), uintptr(attribute), uintptr(attrVal), uintptr(attrValLen))
	ret = HRESULT(r0)
	return
}

func DwmUnregisterThumbnail(thumbnail HTHUMBNAIL) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDwmUnregisterThumbnail.Addr(), uintptr(thumbnail))
	ret = HRESULT(r0)
	return
}

func DwmUpdateThumbnailProperties(thumbnail HTHUMBNAIL, props *DWM_THUMBNAIL_PROPERTIES) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDwmUpdateThumbnailProperties.Addr(), uintptr(thumbnail), uintptr(unsafe.Pointer(props)))
	ret = HRESULT(r0)
	return
}

func GdipAddPathEllipseI(path *GpPath, x int32, y int32, width int32, height int32) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipAddPathEllipseI.Addr(), uintptr(unsafe.Pointer(path)), uintptr(x), uintptr(y), uintptr(width), uintptr(height))
	ret = GpStatus(r0)
	return
}

func GdipCreateBitmapFromFile(filename *uint16, bitmap **GpBitmap) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreateBitmapFromFile.Addr(), uintptr(unsafe.Pointer(filename)), uintptr(unsafe.Pointer(bitmap)))
	ret = GpStatus(r0)
	return
}

func GdipCreateBitmapFromGraphics(width int32, height int32, graphics *GpGraphics, bitmap **GpBitmap) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreateBitmapFromGraphics.Addr(), uintptr(width), uintptr(height), uintptr(unsafe.Pointer(graphics)), uintptr(unsafe.Pointer(bitmap)))
	ret = GpStatus(r0)
	return
}

func GdipCreateBitmapFromHBITMAP(hbm HBITMAP, hpal HPALETTE, bitmap **GpBitmap) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreateBitmapFromHBITMAP.Addr(), uintptr(hbm), uintptr(hpal), uintptr(unsafe.Pointer(bitmap)))
	ret = GpStatus(r0)
	return
}

func GdipCreateBitmapFromHICON(hicon HICON, bitmap **GpBitmap) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreateBitmapFromHICON.Addr(), uintptr(hicon), uintptr(unsafe.Pointer(bitmap)))
	ret = GpStatus(r0)
	return
}
...
func GdipCreateBitmapFromScan0(width int32, height int32, stride int32, format PixelFormat, scan0 *byte, bitmap **GpBitmap) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreateBitmapFromScan0.Addr(), uintptr(width), uintptr(height), uintptr(stride), uintptr(format), uintptr(unsafe.Pointer(scan0)), uintptr(unsafe.Pointer(bitmap)))
	ret = GpStatus(r0)
	return
}

func GdipCreateBitmapFromStream(stream *com.IStreamABI, bitmap **GpBitmap) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreateBitmapFromStream.Addr(), uintptr(unsafe.Pointer(stream)), uintptr(unsafe.Pointer(bitmap)))
	ret = GpStatus(r0)
	return
}

func GdipCreateFontFamilyFromName(name *uint16, collection *GpFontCollection, family **GpFontFamily) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreateFontFamilyFromName.Addr(), uintptr(unsafe.Pointer(name)), uintptr(unsafe.Pointer(collection)), uintptr(unsafe.Pointer(family)))
	ret = GpStatus(r0)
	return
}

func GdipCreateFromHDC(hdc HDC, graphics **GpGraphics) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreateFromHDC.Addr(), uintptr(hdc), uintptr(unsafe.Pointer(graphics)))
	ret = GpStatus(r0)
	return
}

func GdipCreateHBITMAPFromBitmap(bitmap *GpBitmap, hbmReturn *HBITMAP, background ARGB) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreateHBITMAPFromBitmap.Addr(), uintptr(unsafe.Pointer(bitmap)), uintptr(unsafe.Pointer(hbmReturn)), uintptr(background))
	ret = GpStatus(r0)
	return
}

func GdipCreateHICONFromBitmap(bitmap *GpBitmap, hbmReturn *HICON) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreateHICONFromBitmap.Addr(), uintptr(unsafe.Pointer(bitmap)), uintptr(unsafe.Pointer(hbmReturn)))
	ret = GpStatus(r0)
	return
}

func GdipCreatePath(fillMode FillMode, path **GpPath) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreatePath.Addr(), uintptr(fillMode), uintptr(unsafe.Pointer(path)))
	ret = GpStatus(r0)
	return
}

func GdipCreateSolidFill(color ARGB, brush **GpSolidFill) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreateSolidFill.Addr(), uintptr(color), uintptr(unsafe.Pointer(brush)))
	ret = GpStatus(r0)
	return
}

func GdipCreateStringFormat(flags StringFormatFlags, language LANGID, format **GpStringFormat) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipCreateStringFormat.Addr(), uintptr(flags), uintptr(language), uintptr(unsafe.Pointer(format)))
	ret = GpStatus(r0)
	return
}

func GdipDeleteBrush(brush *GpBrush) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipDeleteBrush.Addr(), uintptr(unsafe.Pointer(brush)))
	ret = GpStatus(r0)
	return
}

func GdipDeleteFont(font *GpFont) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipDeleteFont.Addr(), uintptr(unsafe.Pointer(font)))
	ret = GpStatus(r0)
	return
}

func GdipDeleteFontFamily(family *GpFontFamily) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipDeleteFontFamily.Addr(), uintptr(unsafe.Pointer(family)))
	ret = GpStatus(r0)
	return
}

func GdipDeleteGraphics(graphics *GpGraphics) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipDeleteGraphics.Addr(), uintptr(unsafe.Pointer(graphics)))
	ret = GpStatus(r0)
	return
}

func GdipDeletePath(path *GpPath) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipDeletePath.Addr(), uintptr(unsafe.Pointer(path)))
	ret = GpStatus(r0)
	return
}

func GdipDeleteStringFormat(format *GpStringFormat) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipDeleteStringFormat.Addr(), uintptr(unsafe.Pointer(format)))
	ret = GpStatus(r0)
	return
}

func GdipDisposeImage(image *GpImage) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipDisposeImage.Addr(), uintptr(unsafe.Pointer(image)))
	ret = GpStatus(r0)
	return
}

func GdipDrawImageRectI(graphics *GpGraphics, image *GpImage, x int32, y int32, width int32, height int32) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipDrawImageRectI.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(unsafe.Pointer(image)), uintptr(x), uintptr(y), uintptr(width), uintptr(height))
	ret = GpStatus(r0)
	return
}
...
func GdipDrawImageRectRectI(graphics *GpGraphics, image *GpImage, dstX int32, dstY int32, dstWidth int32, dstHeight int32, srcX int32, srcY int32, srcWidth int32, srcHeight int32, srcUnit Unit, imgAttrs *GpImageAttributes, callback uintptr, callbackData uintptr) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipDrawImageRectRectI.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(unsafe.Pointer(image)), uintptr(dstX), uintptr(dstY), uintptr(dstWidth), uintptr(dstHeight), uintptr(srcX), uintptr(srcY), uintptr(srcWidth), uintptr(srcHeight), uintptr(srcUnit), uintptr(unsafe.Pointer(imgAttrs)), uintptr(callback), uintptr(callbackData))
	ret = GpStatus(r0)
	return
}
...
func GdipDrawString(graphics *GpGraphics, text *uint16, textLength int32, font *GpFont, rectf *GpRectF, strFmt *GpStringFormat, brush *GpBrush) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipDrawString.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(unsafe.Pointer(text)), uintptr(textLength), uintptr(unsafe.Pointer(font)), uintptr(unsafe.Pointer(rectf)), uintptr(unsafe.Pointer(strFmt)), uintptr(unsafe.Pointer(brush)))
	ret = GpStatus(r0)
	return
}

func GdipFillEllipseI(graphics *GpGraphics, brush *GpBrush, x int32, y int32, width int32, height int32) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipFillEllipseI.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(unsafe.Pointer(brush)), uintptr(x), uintptr(y), uintptr(width), uintptr(height))
	ret = GpStatus(r0)
	return
}

func GdipGetCompositingMode(graphics *GpGraphics, compositingMode *CompositingMode) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipGetCompositingMode.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(unsafe.Pointer(compositingMode)))
	ret = GpStatus(r0)
	return
}

func GdipGetGenericFontFamilyMonospace(family **GpFontFamily) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipGetGenericFontFamilyMonospace.Addr(), uintptr(unsafe.Pointer(family)))
	ret = GpStatus(r0)
	return
}

func GdipGetGenericFontFamilySansSerif(family **GpFontFamily) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipGetGenericFontFamilySansSerif.Addr(), uintptr(unsafe.Pointer(family)))
	ret = GpStatus(r0)
	return
}

func GdipGetGenericFontFamilySerif(family **GpFontFamily) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipGetGenericFontFamilySerif.Addr(), uintptr(unsafe.Pointer(family)))
	ret = GpStatus(r0)
	return
}

func GdipGetImageDimension(image *GpImage, width *float32, height *float32) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipGetImageDimension.Addr(), uintptr(unsafe.Pointer(image)), uintptr(unsafe.Pointer(width)), uintptr(unsafe.Pointer(height)))
	ret = GpStatus(r0)
	return
}

func GdipGetImageGraphicsContext(image *GpImage, graphics **GpGraphics) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipGetImageGraphicsContext.Addr(), uintptr(unsafe.Pointer(image)), uintptr(unsafe.Pointer(graphics)))
	ret = GpStatus(r0)
	return
}

func GdipGetImageHeight(image *GpImage, height *uint32) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipGetImageHeight.Addr(), uintptr(unsafe.Pointer(image)), uintptr(unsafe.Pointer(height)))
	ret = GpStatus(r0)
	return
}

func GdipGetImageHorizontalResolution(image *GpImage, resolution *float32) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipGetImageHorizontalResolution.Addr(), uintptr(unsafe.Pointer(image)), uintptr(unsafe.Pointer(resolution)))
	ret = GpStatus(r0)
	return
}

func GdipGetImageVerticalResolution(image *GpImage, resolution *float32) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipGetImageVerticalResolution.Addr(), uintptr(unsafe.Pointer(image)), uintptr(unsafe.Pointer(resolution)))
	ret = GpStatus(r0)
	return
}

func GdipGetImageWidth(image *GpImage, width *uint32) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipGetImageWidth.Addr(), uintptr(unsafe.Pointer(image)), uintptr(unsafe.Pointer(width)))
	ret = GpStatus(r0)
	return
}

func GdipGraphicsClear(graphics *GpGraphics, color ARGB) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipGraphicsClear.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(color))
	ret = GpStatus(r0)
	return
}

func GdipResetClip(graphics *GpGraphics) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipResetClip.Addr(), uintptr(unsafe.Pointer(graphics)))
	ret = GpStatus(r0)
	return
}

func GdipSetClipPath(graphics *GpGraphics, path *GpPath, combineMode CombineMode) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipSetClipPath.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(unsafe.Pointer(path)), uintptr(combineMode))
	ret = GpStatus(r0)
	return
}

func GdipSetCompositingMode(graphics *GpGraphics, compositingMode CompositingMode) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipSetCompositingMode.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(compositingMode))
	ret = GpStatus(r0)
	return
}

func GdipSetCompositingQuality(graphics *GpGraphics, compositingQuality CompositingQuality) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipSetCompositingQuality.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(compositingQuality))
	ret = GpStatus(r0)
	return
}

func GdipSetInterpolationMode(graphics *GpGraphics, interpolationMode InterpolationMode) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipSetInterpolationMode.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(interpolationMode))
	ret = GpStatus(r0)
	return
}

func GdipSetPixelOffsetMode(graphics *GpGraphics, pixelOffsetMode PixelOffsetMode) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipSetPixelOffsetMode.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(pixelOffsetMode))
	ret = GpStatus(r0)
	return
}

func GdipSetSmoothingMode(graphics *GpGraphics, smoothingMode SmoothingMode) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipSetSmoothingMode.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(smoothingMode))
	ret = GpStatus(r0)
	return
}

func GdipSetStringFormatAlign(format *GpStringFormat, align StringAlignment) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipSetStringFormatAlign.Addr(), uintptr(unsafe.Pointer(format)), uintptr(align))
	ret = GpStatus(r0)
	return
}

func GdipSetStringFormatLineAlign(format *GpStringFormat, align StringAlignment) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipSetStringFormatLineAlign.Addr(), uintptr(unsafe.Pointer(format)), uintptr(align))
	ret = GpStatus(r0)
	return
}

func GdipSetTextRenderingHint(graphics *GpGraphics, mode TextRenderingHint) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdipSetTextRenderingHint.Addr(), uintptr(unsafe.Pointer(graphics)), uintptr(mode))
	ret = GpStatus(r0)
	return
}

func GdiplusStartup(token *uintptr, input *GdiplusStartupInput, output *GdiplusStartupOutput) (ret GpStatus) {
	r0, _, _ := syscall.SyscallN(procGdiplusStartup.Addr(), uintptr(unsafe.Pointer(token)), uintptr(unsafe.Pointer(input)), uintptr(unsafe.Pointer(output)))
	ret = GpStatus(r0)
	return
}

func SwitchToThread() (ret bool) {
	r0, _, _ := syscall.SyscallN(procSwitchToThread.Addr())
	ret = r0 != 0
	return
}

func GetDpiForMonitor(hmonitor HMONITOR, dpiType MONITOR_DPI_TYPE, dpiX *uint32, dpiY *uint32) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procGetDpiForMonitor.Addr(), uintptr(hmonitor), uintptr(dpiType), uintptr(unsafe.Pointer(dpiX)), uintptr(unsafe.Pointer(dpiY)))
	ret = HRESULT(r0)
	return
}

func GetDpiForShellUIComponent(component SHELL_UI_COMPONENT) (ret uint32) {
	r0, _, _ := syscall.SyscallN(procGetDpiForShellUIComponent.Addr(), uintptr(component))
	ret = uint32(r0)
	return
}

func GetScaleFactorForMonitor(hmonitor HMONITOR, scalePercent *uint32) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procGetScaleFactorForMonitor.Addr(), uintptr(hmonitor), uintptr(unsafe.Pointer(scalePercent)))
	ret = HRESULT(r0)
	return
}
...
func CalculatePopupWindowPosition(anchorPoint *POINT, windowSize *SIZE, flags uint32, optionalExcludeRect *RECT, outPopupWindowPosition *RECT) (err error) {
	r1, _, e1 := syscall.SyscallN(procCalculatePopupWindowPosition.Addr(), uintptr(unsafe.Pointer(anchorPoint)), uintptr(unsafe.Pointer(windowSize)), uintptr(flags), uintptr(unsafe.Pointer(optionalExcludeRect)), uintptr(unsafe.Pointer(outPopupWindowPosition)))
	if int32(r1) == 0 {
		err = errnoErr(e1)
	}
	return
...
func CallMsgFilter(msg *MSG, nCode int32) (ret bool) {
	r0, _, _ := syscall.SyscallN(procCallMsgFilterW.Addr(), uintptr(unsafe.Pointer(msg)), uintptr(nCode))
	ret = r0 != 0
	return
}
...
func CreateDialogIndirectParam(instance HINSTANCE, template unsafe.Pointer, parent HWND, dlgProc uintptr, initParam uintptr) (ret HWND, err error) {
	r0, _, e1 := syscall.SyscallN(procCreateDialogIndirectParamW.Addr(), uintptr(instance), uintptr(template), uintptr(parent), uintptr(dlgProc), uintptr(initParam))
	ret = HWND(r0)
	if ret == 0 {
		err = errnoErr(e1)
	}
...
func DefDlgProc(hdlg HWND, msg uint32, wParam uintptr, lParam uintptr) (ret uintptr) {
	r0, _, _ := syscall.SyscallN(procDefDlgProcW.Addr(), uintptr(hdlg), uintptr(msg), uintptr(wParam), uintptr(lParam))
	ret = uintptr(r0)
	return
}
...
func GetNextDlgTabItem(hdlg HWND, hctl HWND, previous bool) (ret HWND, err error) {
	...
	r0, _, e1 := syscall.SyscallN(procGetNextDlgTabItem.Addr(), uintptr(hdlg), uintptr(hctl), uintptr(_p0))
	ret = HWND(r0)
	if ret == 0 {
		err = errnoErr(e1)
	}
...
func GetQueueStatus(flags uint32) (ret uint32) {
	r0, _, _ := syscall.SyscallN(procGetQueueStatus.Addr(), uintptr(flags))
	ret = uint32(r0)
	return
}

func GetWindowTextLength(hwnd HWND) (ret int32) {
	r0, _, _ := syscall.SyscallN(procGetWindowTextLengthW.Addr(), uintptr(hwnd))
	ret = int32(r0)
	return
}

func GetWindowText(hwnd HWND, text *uint16, maxCount int32) (ret int32) {
	r0, _, _ := syscall.SyscallN(procGetWindowTextW.Addr(), uintptr(hwnd), uintptr(unsafe.Pointer(text)), uintptr(maxCount))
	ret = int32(r0)
	return
}
...
func MsgWaitForMultipleObjectsEx(count uint32, handles *windows.Handle, timeoutMillis uint32, wakeMask uint32, flags uint32) (ret uint32, err error) {
	r0, _, e1 := syscall.SyscallN(procMsgWaitForMultipleObjectsEx.Addr(), uintptr(count), uintptr(unsafe.Pointer(handles)), uintptr(timeoutMillis), uintptr(wakeMask), uintptr(flags))
	ret = uint32(r0)
...
func SetWindowText(hwnd HWND, text *uint16) (err error) {
	r1, _, e1 := syscall.SyscallN(procSetWindowTextW.Addr(), uintptr(hwnd), uintptr(unsafe.Pointer(text)))
	if int32(r1) == 0 {
		err = errnoErr(e1)
	}
	return
...
func BeginBufferedPaint(hdcTarget HDC, prcTarget *RECT, format BP_BUFFERFORMAT, paintParams *BP_PAINTPARAMS, phdc *HDC) (pb HPAINTBUFFER, err error) {
	r0, _, e1 := syscall.SyscallN(procBeginBufferedPaint.Addr(), uintptr(hdcTarget), uintptr(unsafe.Pointer(prcTarget)), uintptr(format), uintptr(unsafe.Pointer(paintParams)), uintptr(unsafe.Pointer(phdc)))
	pb = HPAINTBUFFER(r0)
	if pb == 0 {
		err = errnoErr(e1)
	}
...
func BufferedPaintInit() (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procBufferedPaintInit.Addr())
	ret = HRESULT(r0)
	return
}

func BufferedPaintSetAlpha(paintBuf HPAINTBUFFER, prc *RECT, alpha byte) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procBufferedPaintSetAlpha.Addr(), uintptr(paintBuf), uintptr(unsafe.Pointer(prc)), uintptr(alpha))
	ret = HRESULT(r0)
	return
}

func CloseThemeData(hTheme HTHEME) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procCloseThemeData.Addr(), uintptr(hTheme))
	ret = HRESULT(r0)
	return
}

func DrawThemeBackground(hTheme HTHEME, hdc HDC, iPartId int32, iStateId int32, pRect *RECT, pClipRect *RECT) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDrawThemeBackground.Addr(), uintptr(hTheme), uintptr(hdc), uintptr(iPartId), uintptr(iStateId), uintptr(unsafe.Pointer(pRect)), uintptr(unsafe.Pointer(pClipRect)))
	ret = HRESULT(r0)
	return
}

func DrawThemeParentBackground(hWnd HWND, hdc HDC, prc *RECT) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDrawThemeParentBackground.Addr(), uintptr(hWnd), uintptr(hdc), uintptr(unsafe.Pointer(prc)))
	ret = HRESULT(r0)
	return
}
...
func DrawThemeTextEx(hTheme HTHEME, hdc HDC, iPartId int32, iStateId int32, pszText *uint16, iCharCount int32, dwFlags uint32, pRect *RECT, pOptions *DTTOPTS) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procDrawThemeTextEx.Addr(), uintptr(hTheme), uintptr(hdc), uintptr(iPartId), uintptr(iStateId), uintptr(unsafe.Pointer(pszText)), uintptr(iCharCount), uintptr(dwFlags), uintptr(unsafe.Pointer(pRect)), uintptr(unsafe.Pointer(pOptions)))
	ret = HRESULT(r0)
	return
}
...
func EndBufferedPaint(paintBuf HPAINTBUFFER, updateTarget bool) (ret HRESULT) {
	...
	r0, _, _ := syscall.SyscallN(procEndBufferedPaint.Addr(), uintptr(paintBuf), uintptr(_p0))
	ret = HRESULT(r0)
	return
}

func GetThemeColor(hTheme HTHEME, iPartId int32, iStateId int32, iPropId int32, pColor *COLORREF) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procGetThemeColor.Addr(), uintptr(hTheme), uintptr(iPartId), uintptr(iStateId), uintptr(iPropId), uintptr(unsafe.Pointer(pColor)))
	ret = HRESULT(r0)
	return
}

func GetThemeEnumValue(hTheme HTHEME, iPartId int32, iStateId int32, iPropId int32, piVal *int32) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procGetThemeEnumValue.Addr(), uintptr(hTheme), uintptr(iPartId), uintptr(iStateId), uintptr(iPropId), uintptr(unsafe.Pointer(piVal)))
	ret = HRESULT(r0)
	return
}

func GetThemeFont(hTheme HTHEME, hdc HDC, iPartId int32, iStateId int32, iPropId int32, pFont *LOGFONT) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procGetThemeFont.Addr(), uintptr(hTheme), uintptr(hdc), uintptr(iPartId), uintptr(iStateId), uintptr(iPropId), uintptr(unsafe.Pointer(pFont)))
	ret = HRESULT(r0)
	return
}

func GetThemeInt(hTheme HTHEME, iPartId int32, iStateId int32, iPropId int32, piVal *int32) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procGetThemeInt.Addr(), uintptr(hTheme), uintptr(iPartId), uintptr(iStateId), uintptr(iPropId), uintptr(unsafe.Pointer(piVal)))
	ret = HRESULT(r0)
	return
}
...
func GetThemeMargins(hTheme HTHEME, hdc HDC, iPartId int32, iStateId int32, iPropId int32, prc *RECT, pMargins *MARGINS) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procGetThemeMargins.Addr(), uintptr(hTheme), uintptr(hdc), uintptr(iPartId), uintptr(iStateId), uintptr(iPropId), uintptr(unsafe.Pointer(prc)), uintptr(unsafe.Pointer(pMargins)))
	ret = HRESULT(r0)
	return
}

func GetThemeMetric(hTheme HTHEME, hdc HDC, iPartId int32, iStateId int32, iPropId int32, piVal *int32) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procGetThemeMetric.Addr(), uintptr(hTheme), uintptr(hdc), uintptr(iPartId), uintptr(iStateId), uintptr(iPropId), uintptr(unsafe.Pointer(piVal)))
	ret = HRESULT(r0)
	return
}

func GetThemePartSize(hTheme HTHEME, hdc HDC, iPartId int32, iStateId int32, prc *RECT, eSize THEMESIZE, psz *SIZE) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procGetThemePartSize.Addr(), uintptr(hTheme), uintptr(hdc), uintptr(iPartId), uintptr(iStateId), uintptr(unsafe.Pointer(prc)), uintptr(eSize), uintptr(unsafe.Pointer(psz)))
	ret = HRESULT(r0)
	return
}

func GetThemeSysFont(hTheme HTHEME, iFontId int32, plf *LOGFONT) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procGetThemeSysFont.Addr(), uintptr(hTheme), uintptr(iFontId), uintptr(unsafe.Pointer(plf)))
	ret = HRESULT(r0)
	return
}
...
func GetThemeTextExtent(hTheme HTHEME, hdc HDC, iPartId int32, iStateId int32, pszText *uint16, iCharCount int32, dwTextFlags uint32, pBoundingRect *RECT, pExtentRect *RECT) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procGetThemeTextExtent.Addr(), uintptr(hTheme), uintptr(hdc), uintptr(iPartId), uintptr(iStateId), uintptr(unsafe.Pointer(pszText)), uintptr(iCharCount), uintptr(dwTextFlags), uintptr(unsafe.Pointer(pBoundingRect)), uintptr(unsafe.Pointer(pExtentRect)))
	ret = HRESULT(r0)
	return
}

func IsAppThemed() (ret bool) {
	r0, _, _ := syscall.SyscallN(procIsAppThemed.Addr())
	ret = r0 != 0
	return
}

func IsThemeBackgroundPartiallyTransparent(hTheme HTHEME, iPartId int32, iStateId int32) (ret bool) {
	r0, _, _ := syscall.SyscallN(procIsThemeBackgroundPartiallyTransparent.Addr(), uintptr(hTheme), uintptr(iPartId), uintptr(iStateId))
	ret = r0 != 0
	return
}

func OpenThemeData(hwnd HWND, pszClassList *uint16) (ret HTHEME) {
	r0, _, _ := syscall.SyscallN(procOpenThemeData.Addr(), uintptr(hwnd), uintptr(unsafe.Pointer(pszClassList)))
	ret = HTHEME(r0)
	return
}

func SetWindowTheme(hwnd HWND, pszSubAppName *uint16, pszSubIdList *uint16) (ret HRESULT) {
	r0, _, _ := syscall.SyscallN(procSetWindowTheme.Addr(), uintptr(hwnd), uintptr(unsafe.Pointer(pszSubAppName)), uintptr(unsafe.Pointer(pszSubIdList)))
	ret = HRESULT(r0)
	return
}
